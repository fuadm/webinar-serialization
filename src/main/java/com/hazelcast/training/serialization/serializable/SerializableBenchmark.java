...
package com.hazelcast.training.serialization.serializable;
...
public class SerializableBenchmark implements ShoppingCartBenchmark{
    ...
    public void setUp() {
        ...
        SerializationConfig sg = config.getSerializationConfig();
    ...
    public Object createObject(Random random) {
        return createNewShoppingCart(random);
    }
}
